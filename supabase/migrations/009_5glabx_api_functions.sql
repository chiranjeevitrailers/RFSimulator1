-- 5GLabX API Functions
-- This migration creates RPC functions for all 5GLabX features
...
BEGIN
  ...
  INSERT INTO public.test_executions (test_case_id, user_id, status)
  VALUES (test_case_id, auth.uid(), 'running')
