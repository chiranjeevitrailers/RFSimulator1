...
export const NtnAnalyticsPage: React.FC = () => {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">NTN Analytics</h1>
          <p className="text-base-content/70">
            Real-time NTN analytics and performance monitoring
          </p>
        </div>
      </div>
          ...
          <div className="card-body">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">450 Mbps</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="card bg-base-100">
        <div className="card-body">
          <h2 className="card-title">NTN Analytics Dashboard</h2>
          <p className="text-base-content/70">Real-time NTN performance analytics and insights</p>
        </div>
      </div>
    </div>
  )
...
export default NtnAnalyticsPage