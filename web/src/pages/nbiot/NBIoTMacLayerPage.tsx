...
export const NBIoTMacLayerPage: React.FC = () => {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">NB-IoT MAC Layer</h1>
          <p className="text-base-content/70">
            MAC layer analysis for NB-IoT devices
          </p>
        </div>
      </div>
          ...
          <div className="card-body">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">1,250/sec</p>
              </div>
            </div>
          </div>
        </div>
...
export default NBIoTMacLayerPage