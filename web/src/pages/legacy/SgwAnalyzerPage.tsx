...
export const SgwAnalyzerPage: React.FC = () => {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">SGW Analyzer</h1>
          <p className="text-base-content/70">
            Serving Gateway analysis for 4G Legacy
          </p>
        </div>
      </div>
          ...
          <div className="card-body">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">12,891</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card-body">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">3.2ms</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="card bg-base-100">
        <div className="card-body">
          <h2 className="card-title">SGW Performance</h2>
...
export default SgwAnalyzerPage